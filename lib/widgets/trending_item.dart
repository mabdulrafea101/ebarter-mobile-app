...
class TrendingItem extends StatelessWidget {
  ...
  _productDetails() {
    return Column(
      ...
      children: <Widget>[
        Text(
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vel purus at libero imperdiet vestibulum eu ut est. Morbi diam ex, rhoncus eu felis vel, aliquam lacinia enim. Integer sit amet mauris arcu',
        ...
        Row(
          children: <Widget>[
            Text(product.estPrice.toString(),
                style: TextStyle(
                    fontSize: 15,
